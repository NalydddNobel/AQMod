...
internal class InstancedPetBuff : InstancedBuff {
    ...
    public InstancedPetBuff(UnifiedModPet modPet, RefFunc<Player, bool> petFlag, bool lightPet) : base(modPet.Name + "Buff", modPet.NamespaceFilePath() + $"/{modPet.Name}Buff") {
        _modPet = modPet;
        _petFlag = petFlag;
        _lightPet = lightPet;
    }
