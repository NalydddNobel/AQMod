...
public class SaveActions : ILoad {
    ...
    public void Load(Mod mod) {
        HookManager.ApplyAndCacheHook(Aequu2.TerrariaAssembly.GetType("Terraria.ModLoader.IO.WorldIO").GetMethod("Save", BindingFlags.NonPublic | BindingFlags.Static), typeof(SaveActions).GetMethod(nameof(On_WorldIO_Save), BindingFlags.NonPublic | BindingFlags.Static));
    }
