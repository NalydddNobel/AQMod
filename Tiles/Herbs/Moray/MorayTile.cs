...
namespace Aequus.Tiles.Herbs.Moray;
public class MorayTile : HerbTileBase {
    protected override int[] GrowableTiles => [
        TileID.Grass,
        TileID.HallowedGrass,
        TileID.Sand,
        TileID.HardenedSand,
#if !CRAB_CREVICE_DISABLE
        ModContent.TileType<Tiles.CrabCrevice.SedimentaryRockTile>(),
#endif
    ];
...
#if !CRAB_CREVICE_DISABLE
        return TryPlaceHerb<MorayTile>(i, j, 3, TileID.Sand, TileID.HardenedSand, TileID.Sandstone, ModContent.TileType<Tiles.CrabCrevice.SedimentaryRockTile>());
#endif
        return false;
    }
}