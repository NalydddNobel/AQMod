...
public class GravityChestTrapped : TrappedChestBaseItem<GravityChestTileTrapped, GravityChestTile, GravityChest> {
}

public class GravityChestTileTrapped : TrappedChestBaseTile<GravityChestTile, GravityChest> {
}
#endregion