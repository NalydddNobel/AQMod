...
namespace AQMod.Assets.Graphics
{
    public class NarrizuulPickupDrawObject : IDrawObject // unfinished
    {
        ...
        void IDrawType.RunDraw()
        {
            ...
            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, new Vector2(position.X - Main.screenPosition.X - off, y + origin.Y), borderClr, rotation, origin, scale, SpriteEffects.None, 0f);
            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, new Vector2(position.X - Main.screenPosition.X + off, y + origin.Y), borderClr, rotation, origin, scale, SpriteEffects.None, 0f);
            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, new Vector2(position.X - Main.screenPosition.X, y + origin.Y + off), borderClr, rotation, origin, scale, SpriteEffects.None, 0f);
            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, new Vector2(position.X - Main.screenPosition.X, y + origin.Y - off), borderClr, rotation, origin, scale, SpriteEffects.None, 0f);

            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, drawPos, color, rotation, origin, scale, SpriteEffects.None, 0f);

            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, drawPos + new Vector2(off, 0).RotatedBy(Main.GlobalTime), new Color(255, 0, 0, 0), rotation, origin, scale, SpriteEffects.None, 0f);
            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, drawPos + new Vector2(off, 0).RotatedBy(Main.GlobalTime + MathHelper.TwoPi / 6), new Color(255, 255, 0, 0), rotation, origin, scale, SpriteEffects.None, 0f);
            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text, drawPos + new Vector2(off, 0).RotatedBy(Main.GlobalTime + MathHelper.TwoPi / 6 * 2f), new Color(0, 0, 255, 0), rotation, origin, scale, SpriteEffects.None, 0f);
