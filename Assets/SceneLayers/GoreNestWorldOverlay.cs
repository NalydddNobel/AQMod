...
{
    public sealed class GoreNestWorldOverlay : SceneLayer
    {
        public const string KEY = "AQMod:GoreNestPortals";
        ...
        public GoreNestWorldOverlay(bool test = true)
        {
            x = new ushort[Length];
            y = new ushort[Length];
            index = 0;
        ...
        public override void Draw()
        {
            for (int k = 0; k < index; k++)
            {
                ...
                {
                    var texture = DrawUtils.Textures.Lights[Enumerators.LightID.Spotlight66x66Negative];
                ...
                if (_test)
                {
                    ...
                    ChatManager.DrawColorCodedString(Main.spriteBatch, font, text, portalPosition + new Vector2(0f, -200f) - Main.screenPosition, Color.White, 0f, orig, Vector2.One);
                }
