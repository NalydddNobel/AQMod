...
{
    public class SkyLayer : CustomSky
    {
        private static Dictionary<string, BackgroundSceneLayer> _layers;

        public const string Name = "AQMod:SkyLayer";
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                AQMod.WorldLayers.DrawLayer(SceneLayering.Sky);
            }
        }
