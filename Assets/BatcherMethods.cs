...
namespace AQMod.Assets
{
    internal static class BatcherMethods
    {
        ...
        public static class Background
        {
            ...
            {
                spriteBatch.Begin(spriteSort, BlendState.AlphaBlend, SamplerState.LinearClamp, DepthStencilState.None, Main.Rasterizer, null, Main.BackgroundViewMatrix.TransformationMatrix);
            }
        }
