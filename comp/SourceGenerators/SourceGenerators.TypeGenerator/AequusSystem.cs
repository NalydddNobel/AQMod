...
public partial class AequusSystem {
    ...
    [CompilerGenerated]
    public static readonly Condition ConditionUsedReforgeBook = new("Mods.AequusRemake.Condition.UsedReforgeBook", () => usedReforgeBook);
    [CompilerGenerated]
    public static readonly Condition ConditionNotUsedReforgeBook = new("Mods.AequusRemake.Condition.UsedReforgeBook", () => !usedReforgeBook);
    [CompilerGenerated]
    public static bool downedSalamancer;
    [CompilerGenerated]
    public static readonly Condition ConditionDownedSalamancer = new("Mods.AequusRemake.Condition.DownedSalamancer", () => downedSalamancer);
    [CompilerGenerated]
    public static readonly Condition ConditionNotDownedSalamancer = new("Mods.AequusRemake.Condition.DownedSalamancer", () => !downedSalamancer);
