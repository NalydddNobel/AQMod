...
namespace AQMod.Projectiles.Ranged
{
    public class HamaYumiArrow : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture(CommonUtils.GetPath<HamaYumiArrow>() + "_Aura"), projectile.position + offset - Main.screenPosition, null, new Color(60, 2, 100, 0) * intensity, rotation, textureOrig, projectile.scale, SpriteEffects.None, 0f);
            ...
            if (intensity > 10f)
            {
                ...
                Main.spriteBatch.Draw(ModContent.GetTexture(CommonUtils.GetPath<HamaYumiArrow>() + "_Aura"), projectile.position + offset - Main.screenPosition, null, new Color(20, 8, 50, 0) * intensity, rotation, textureOrig, projectile.scale, SpriteEffects.None, 0f);
