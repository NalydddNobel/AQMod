...
namespace Aequus.Projectiles.Monster.RedSprite
{
    public class RedSpriteCloudLightning : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            NPCs.Monsters.Sky.RedSprite.DrawWithAura(Main.spriteBatch, texture, drawPosition - Main.screenPosition, frame, lightColor, Projectile.rotation, origin, Projectile.scale, auraIntensity: -4f);
            return false;
        }
