...
namespace AQMod.Projectiles.Magic
{
    public class NarrenBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int d = Dust.NewDust(projectile.Center, 0, 0, ModContent.DustType<Dusts.ColorlessTransparentOrb>());
        ...
        {
            Texture2D texture = SpriteUtils.Textures.Glows[GlowID.NarrenBolt];
            ...
            if (Trailshader.ShouldDrawVertexTrails(Trailshader.GetVertexDrawingContext_Projectile(projectile)))
            {
                ...
                {
                    Trailshader trail = new Trailshader(SpriteUtils.Textures.Trails[TrailID.ThickLine], Trailshader.TextureTrail);
            ...
            texture = SpriteUtils.Textures.Lights[LightID.Spotlight66x66];
