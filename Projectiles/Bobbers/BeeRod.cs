    ...
    public class BeeRod : ModProjectile
    {
        ...
        public override bool PreDrawExtras(SpriteBatch spriteBatch)
        {
            ...
            if (!projectile.bobber || player.inventory[player.selectedItem].holdStyle <= 0)
                return false;
            AQGraphics.Rendering.DrawFishingLine(projectile.whoAmI % 2 == 0 ? new Color(255, 255, 0, 255) : new Color(20, 0, 20, 255), player, projectile.position, projectile.width, projectile.height, projectile.velocity, projectile.localAI[0], new Vector2(36f, 28f));
            return false;
        }
    }
}