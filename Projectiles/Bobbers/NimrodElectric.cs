    ...
    public class NimrodElectric : ModProjectile
    {
        ...
        public override bool PreDrawExtras(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < Main.maxProjectiles; i++)
            {
                ...
                {
                    AQGraphics.Drawing.DrawFishingLine_NoLighting_UseCustomOrigin(new Color(0, 172, 255, 200), player, projectile.position, projectile.width / 2, projectile.height, projectile.velocity, projectile.localAI[0], Main.projectile[i].Center + new Vector2(Main.projectile[i].width / -2f, 0f));
                    break;
                }
            }
            return false;
