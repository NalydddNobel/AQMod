...
{
    public class Starite : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (leader < 0 || !Main.projectile[leader].active || Main.projectile[leader].type != ModContent.ProjectileType<StariteLeader>())
            {
                projectile.Kill();
            }
            else
        ...
        {
            int leaderType = ModContent.ProjectileType<StariteLeader>();
