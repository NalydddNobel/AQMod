...
namespace Aequus.Projectiles.Summon.CandleSpawners {
    public class FallenAngelProj : BaseGhostSpawner
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(AequusTextures.Bloom2, drawCoords, null, Color.White * 0.5f * Projectile.Opacity,
                0f, AequusTextures.Bloom2.Size() / 2f, Projectile.scale * 0.75f, SpriteEffects.None, 0);
