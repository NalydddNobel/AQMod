...
namespace Aequus.Projectiles.Melee
{
    public class VrangProj : ModProjectile
    {
        ...
        public void OnSpawn_NewProj(IEntitySource source, Vector2 location, Vector2 velocity, sbyte temperatureCalc, int direction)
        {
            ...
            p.ModProjectile<VrangProj>().temperature = temperatureCalc;
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (temperature != 0)
            {
                ...
                Main.spriteBatch.Draw(maskTexture.Value, center - Main.screenPosition, frame, lightColor, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
            }
            return false;
        }
