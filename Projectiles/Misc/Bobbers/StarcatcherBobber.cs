    ...
    public class StarcatcherBobber : ModProjectile
    {
        ...
        public override bool PreDrawExtras()
        {
            ...
            if (!Projectile.bobber || player.inventory[player.selectedItem].holdStyle <= 0)
                return false;
            AequusHelpers.DrawFishingLine(player, Projectile.position, Projectile.width / 2, Projectile.height, Projectile.velocity, Projectile.localAI[0], Main.player[Projectile.owner].Center + new Vector2(42f * Main.player[Projectile.owner].direction, -28f),
