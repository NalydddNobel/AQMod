...
{
    public class AshCrossGraveMarkerProj : TombstoneProjBase
    {
        ...
        public override int TileStyle => Tiles.Furniture.AshTombstones.Style_AshCrossGraveMarker;
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(Glow.Value, drawCoordinates, frame, new Color(200, 100, 100, 0) * Helper.Wave(Main.GlobalTimeWrappedHourly * 3f, 0.2f, 0.5f), Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
        }
    }
}