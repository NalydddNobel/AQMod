...
namespace Aequus.Projectiles.Misc.Friendly
{
    public class ShieldOfCthulhuBoost : ModProjectile
    {
        ...
        {
            Main.instance.PrepareDrawnEntityDrawing(Projectile, Main.player[Projectile.owner].cShield, null);
            ...
            Main.EntitySpriteDraw(AequusTextures.Bloom0, Projectile.position + offset - Main.screenPosition, null, new Color(128, 20, 10, 30) * Projectile.Opacity * 0.8f, Projectile.rotation, AequusTextures.Bloom0.Size() / 2f, new Vector2(1.5f, 1f) * Projectile.scale, effects, 0);
