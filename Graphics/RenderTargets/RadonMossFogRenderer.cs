...
namespace Aequus.Graphics.RenderTargets
{
    public class RadonMossFogRenderer : ScreenTarget
    {
        ...
        public static StaticMiscShaderInfo Shader { get; private set; }
        ...
        public override void Load(Mod mod)
        {
            ...
            if (!Main.dedServ)
            {
                Shader = new StaticMiscShaderInfo("RadonMossShader", "Aequus:RadonMossFog", "RadonShaderPass", loadStatics: true);
            }
        }
