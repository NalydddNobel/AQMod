...
public abstract class FloorHazard(FloorHazard.FloorHazardInfo info) : ModProjectile {
    ...
    public readonly record struct FloorHazardInfo(bool HurtsPlayers, bool HurtsNPCs, bool HurtsProjectiles, int StartWidth = 2, int StartHeight = 2);
