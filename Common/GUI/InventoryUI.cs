...
public class InventoryUI : ModSystem {
    ...
    public static readonly HashSet<int> ContextsInv = [
    ...
    public override void UpdateUI(GameTime gameTime) {
        ...
        if (CoinsAmmoOffsetX < rightSlotOffset) {
            ...
            CoinsAmmoOffsetX++;
            if (CoinsAmmoOffsetX > rightSlotOffset) {
                CoinsAmmoOffsetX = rightSlotOffset;
            }
        }
        else if (CoinsAmmoOffsetX > rightSlotOffset) {
            CoinsAmmoOffsetX = (int)MathHelper.Lerp(CoinsAmmoOffsetX, rightSlotOffset, 0.1f);
            CoinsAmmoOffsetX--;
            if (CoinsAmmoOffsetX < rightSlotOffset) {
                CoinsAmmoOffsetX = rightSlotOffset;
            }
    ...
    private void IL_Main_DrawInventory(ILContext il) {
        ...
        void MoveAchievementAdvisor(ILCursor cursor) {
        ...
        void MoveChestIcons(ILCursor cursor) {
        ...
        void MoveSlots(ILCursor cursor, string weirdHardcodedNameLeftover, float hardcodedTextXValue, int hardcodedSlotXValue) {
            // Find the "Coins" text
