    ...
    public sealed class NecromancyTypes : LoadableType
    {
        ...
        public override void Load()
        {
            ...
            NPCs = new Dictionary<int, NecroStats>()
            {
                ...
                [NPCID.Antlion] = NecroStats.Two,
                [NPCID.Squid] = NecroStats.Two,
                [NPCID.Skeleton] = NecroStats.Two,
                [NPCID.SkeletonAlien] = NecroStats.Two,
                [NPCID.SkeletonAstonaut] = NecroStats.Two,
                [NPCID.SkeletonTopHat] = NecroStats.Two,
                [NPCID.HeadacheSkeleton] = NecroStats.Two,
                [NPCID.MisassembledSkeleton] = NecroStats.Two,
                [NPCID.PantlessSkeleton] = NecroStats.Two,
                [NPCID.SporeSkeleton] = NecroStats.Two,
                [NPCID.SlimeSpiked] = NecroStats.Two,
                [NPCID.Crawdad] = NecroStats.Two,
                [NPCID.Crawdad2] = NecroStats.Two,
                [NPCID.Salamander] = NecroStats.Two,
                [NPCID.Salamander2] = NecroStats.Two,
                [NPCID.Salamander3] = NecroStats.Two,
                [NPCID.Salamander4] = NecroStats.Two,
                [NPCID.Salamander5] = NecroStats.Two,
                [NPCID.Salamander6] = NecroStats.Two,
                [NPCID.Salamander7] = NecroStats.Two,
                [NPCID.Salamander8] = NecroStats.Two,
                [NPCID.Salamander9] = NecroStats.Two,
                [NPCID.IceBat] = NecroStats.Two,
                [NPCID.SeaSnail] = NecroStats.Two,
                [NPCID.GoblinScout] = NecroStats.Two,
                [NPCID.GraniteGolem] = NecroStats.Two,
                [NPCID.FaceMonster] = NecroStats.Two,
                [NPCID.FlyingAntlion] = NecroStats.Two,
                [NPCID.WalkingAntlion] = NecroStats.Two,
