...
{
    public class LegacyLegacyGlowmask : ItemOverlayData
    {
        ...
        public LegacyLegacyGlowmask(GlowID glowmask)
        {
            this.glowmask = glowmask;
            drawColor = DefaultDrawColor;
        }

        public LegacyLegacyGlowmask(GlowID glowmask, Color drawColor)
        {
            this.glowmask = glowmask;
        ...
        {
            Texture2D texture = DrawUtils.LegacyTextureCache.Glows[glowmask];
