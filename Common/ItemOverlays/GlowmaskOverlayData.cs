...
{
    public class GlowmaskOverlayData : ItemOverlayData
    {
        ...
        internal GlowmaskOverlayData(string path)
        {
        ...
        internal GlowmaskOverlayData(string path, Color color)
        {
            Texture = new TextureAsset(path);
            drawColor = color;
            shader = 0;
        ...
        internal GlowmaskOverlayData(string path, Color color, int shader)
        {
            Texture = new TextureAsset(path);
            drawColor = color;
            this.shader = shader;
