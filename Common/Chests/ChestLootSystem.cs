...
public class ChestLootSystem : ModSystem {
    ...
    public override void PostWorldGen() {
        ...
        static void AddLoot(int chestId) {
            ...
            if (WallID.Sets.AllowsUndergroundDesertEnemiesToSpawn[wallId]) {
                ChestLootDatabase.Instance.SolveRules(ChestLoot.Sandstone, info);
                return;
            }
            ...
            if (chest.y < Main.worldSurface || wallId == WallID.LivingWoodUnsafe) {
                ...
                // Sky Island
                if (wallId == WallID.DiscWall || (type == TileID.Containers && (style == ChestType.Skyware || style == ChestType.LockedGold))) {
                    return;
                }
            ...
            // Underground Chests
                ...
                // Polluted Ocean
                if (type == TileID.Containers && style == ChestType.TrashCan) {
                    return;
                }
