...
public class LegacySpriteBatchCache : ILoadable {
    ...
    public LegacySpriteBatchCache() {
    }

    public LegacySpriteBatchCache(SpriteSortMode sortMode, BlendState blendState, SamplerState samplerState, DepthStencilState depthStencilState,
    ...
    public LegacySpriteBatchCache(SpriteBatch spriteBatch) {
        Inherit(spriteBatch);
    }
