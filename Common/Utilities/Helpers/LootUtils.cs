...
public static class LootUtils {
    ...
    public static ItemDropAttemptResult ResolveRule(IItemDropRule rule, in DropAttemptInfo info) {
        return (_resolveRule?.Invoke(Main.ItemDropSolver, [rule, info]) as ItemDropAttemptResult?) ?? new ItemDropAttemptResult() { State = ItemDropAttemptResultState.DidNotRunCode };
    }
    ...
    public static void RemoveAll(NPCLoot loot, Predicate<IItemDropRule> predicate) {
