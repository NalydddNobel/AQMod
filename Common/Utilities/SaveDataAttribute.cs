...
public class SaveDataAttribute : Attribute {
    ...
    public static void LoadData(TagCompound tag, object me) {
        ...
        foreach (var m in Helper.GetFieldsPropertiesOfAttribute<SaveDataAttribute>(me.GetType(), BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static)) {
            if (m.info.GetCustomAttribute<IsListedBooleanAttribute>() != null) {
