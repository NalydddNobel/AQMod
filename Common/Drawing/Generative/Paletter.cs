...
internal class Paletter(Texture2D TemplatePalette, Texture2D TemplateTexture) : IDisposable {
    private readonly Texture2D _templatePalette = TemplatePalette;
    private readonly Texture2D _templateTexture = TemplateTexture;
