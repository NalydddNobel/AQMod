...
public abstract class LegacyPotBase : ModTile {
    ...
    public virtual bool PreDropEffects(int i, int j) {
        return true;
    }

    public virtual void ModifyPotionDrop(ref int itemID, ref int stack, UnifiedRandom rng) { }

    public virtual bool ChooseSpecialBiomeTorch(ref int itemID) {
        return false;
    }

    public virtual int ChooseGlowstick(int i, int j) {
