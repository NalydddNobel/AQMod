...
public class AequusTextboxElement : UIState {
    public Int32 maxText = -1;
    public Color color;
    public Int32 textOffsetY = 5;

    public String text;
    public String ShowText;
    public Boolean focused;

    public AequusTextboxElement(Color color = default, Int32 maxText = -1, Int32 textOffsetY = 5) {
        this.color = color;
    ...
    public override void Draw(SpriteBatch spriteBatch) {
        ...
        Boolean hovering = Main.mouseX > dimensions.X && Main.mouseX < dimensions.Y + dimensions.Width && Main.mouseY > dimensions.Y && Main.mouseY < dimensions.Y + dimensions.Height;
        if (hovering) {
        ...
        Utils.DrawInvBG(Main.spriteBatch, dimensions.ToRectangle() with { Width = (Int32)Math.Max(dimensions.Width, measurement.X + 20f) }, inventoryBackColor);
