...
public class AequusItemSlotElement : UIElement {
    ...
    public Boolean HasItem => item != null && !item.IsAir;
    ...
    public override void Draw(SpriteBatch spriteBatch) {
        var c = GetDimensions();
        Single dimensionMin = Math.Min(c.Width, c.Height);
        Single newScale = dimensionMin / 52f;
        Single oldScale = Main.inventoryScale;
