...
public class AequusPlaceableItemSlotElement : AequusItemSlotElement {
    public Func<Item, Boolean> CanPlaceInSlot;
    public Func<Item, Boolean> TakeOutOfSlot;
    public Action<Item, Item> OnSlotSwap;
    public Boolean SingleStack;

    public AequusPlaceableItemSlotElement(Texture2D back, Asset<Texture2D> icon = null, Rectangle? frame = null) : base(back, icon, frame) {
    }
