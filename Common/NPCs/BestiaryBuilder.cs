...
/// <summary>Helper class for setting up bestiary entries.</summary>
internal static class BestiaryBuilder {
    public struct Entry {
        ...
        public Entry UseInfoProvider(IBestiaryUICollectionInfoProvider infoProvider) {
    ...
    public static void MoveBestiaryEntry(ModNPC modNPC, int npcIdToSortAfter, int sortOffset = 0) {
        try {
