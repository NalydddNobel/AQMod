...
public abstract class UnifiedBoss(BossParams BossParams, TrophyParams Trophy = default) : ModNPC {
    ...
    protected string GetItemPath() {
        return $"{this.NamespacePath()}/Items/";
    }
    ...
    public override void ModifyNPCLoot(NPCLoot npcLoot) {
        ...
        if (TreasureBagItem != null && MaskItem != null) {
            npcLoot.AddBossLoot(TreasureBagItem.Type, ItemDropRule.Common(MaskItem.Type, chanceDenominator: 7));
        }
    }
}

internal class InstancedBossBag(ModNPC ModNPC, int InternalRarity, bool PreHardmode = false) : InstancedModItem($"{ModNPC.Name}Bag", $"{ModNPC.NamespacePath()}/Items/{ModNPC.Name}Bag") {
    ...
    public override void SetStaticDefaults() {
        ...
        ItemID.Sets.PreHardmodeLikeBossBag[Type] = _preHardmode;
