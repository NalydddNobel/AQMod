...
public partial class BestiaryTagCollection(IEnumerable<IFilterInfoProvider> ValidTags) {
    public BestiaryTagCollection(params IFilterInfoProvider[] ValidTags) : this(ValidTags as IEnumerable<IFilterInfoProvider>) { }
    public BestiaryTagCollection(params BestiaryTagCollection[] validTags) : this(validTags.SelectMany(t => t._tags)) { }
