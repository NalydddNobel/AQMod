...
namespace AQMod.Common.UserInterface
{
	public class TextUI
	{
		...
		public void Draw(int x, int y, int width, int height, int maxText = -1, Color color = default(Color))
		{
			...
			if (drawnText != "")
			{
				...
				ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, Main.fontMouseText, drawnText, new Vector2(x + 8f, y + height / 2f - measurement.Y / 2f), Color.White, 0f, Vector2.Zero, Vector2.One);
            }
