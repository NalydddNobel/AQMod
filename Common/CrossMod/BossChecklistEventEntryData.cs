...
{
    internal struct BossChecklistEventEntryData : IBossChecklistEntryData
    {
        ...
        public BossChecklistEventEntryData(Func<bool> downed, float progression, List<int> enemies, string eventName, int summonItem = 0, List<int> loot = null, List<int> collectibles = null,
