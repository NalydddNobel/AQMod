...
{
    public struct BossEntry : IBossChecklistEntryData
    {
        ...
        public BossEntry(Func<bool> downed, float progression, int boss, string bossName, int summonItem = 0, List<int> loot = null, List<int> collectibles = null,
        ...
        public BossEntry(Func<bool> downed, float progression, List<int> boss, string eventName, int summonItem = 0, List<int> loot = null, List<int> collectibles = null,
            string summonDescription = null, string texture = null, string bossHeadTexture = null, Func<bool> available = null, string despawnMessage = null)
        {
            isDowned = downed;
            this.progression = progression;
