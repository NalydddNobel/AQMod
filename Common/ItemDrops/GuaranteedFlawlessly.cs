...
{
    public class GuaranteedFlawlessly : IItemDropRule, IItemDropRuleCondition, IProvideItemConditionDescription
    {
        ...
        public GuaranteedFlawlessly(int item, int dropChance)
        {
            Item = item;
