...
namespace Aequus.Events.Glimmer
{
    public class GlimmerSky : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            ...
            {
                spriteBatch.Draw(skyTexture, destinationRectangle, skyColor);
                return;
            }
            ...
            spriteBatch.Draw(skyTexture, destinationRectangle, Color.Lerp(skyColor, Color.Blue * 0.01f, 1f - approxProgress));
        ...
        public override void Activate(Vector2 position, params object[] args)
        {
            ...
            if (skyTexture == null)
            {
                skyTexture = AequusHelpers.GetTexture(this.GetNoNamePath(), "GlimmerSky");
            }
