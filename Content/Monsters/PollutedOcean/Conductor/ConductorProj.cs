...
public class ConductorProj : ModNPC {
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
        ...
        if (!WaterSphere) {
            spriteBatch.Draw(TextureAssets.Npc[Type].Value, drawCoordinates, NPC.frame, drawColor, NPC.rotation, NPC.frame.Size() / 2f, NPC.scale, effects, 0f);
        }
