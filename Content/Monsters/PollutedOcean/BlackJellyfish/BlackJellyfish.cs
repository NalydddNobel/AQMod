...
public partial class BlackJellyfish : ModNPC, IJellyfishAIProvider {
    ...
    private void ShockEffects() {
        ...
        if (Collision.WetCollision(NPC.position, NPC.width, NPC.height)) {
            ...
            foreach (var particle in Instance<UnderwaterBubbles>().NewMultipleReduced(32, 8)) {
        ...
        // Screen Shake
        Helper.PunchTowards(NPC.Center, strength: 6f, frames: 60);
    }
    ...
    bool IJellyfishAIProvider.CanShock() {
        return false;
    }
