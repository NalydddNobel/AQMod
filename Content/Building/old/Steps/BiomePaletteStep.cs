        ...
        public class Interest : StepInterest {
            ...
            public override void CompileInterestingPoints(StepInfo info) {
                ...
                try {
                    ...
                    Main.SceneMetrics.ScanAndExportToMain(new SceneMetricsScanSettings() { BiomeScanCenterPositionInWorld = Main.LocalPlayer.position, VisualScanArea = null, ScanOreFinderData = false, });
