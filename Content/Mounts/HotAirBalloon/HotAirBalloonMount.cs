...
public partial class HotAirBalloonMount : UnifiedMount {
    ...
    public static readonly Dictionary<string, IBalloonData> NameSpecific = new() {
        ...
        ["nalyddd"] = new DynamicColorBalloonData(0, () => Color.Lerp(Color.Violet, Color.BlueViolet, Helper.Wave(Main.GlobalTimeWrappedHourly, 0f, 1f)), () => Color.BlueViolet)
    };
    ...
    public override bool Draw(List<DrawData> playerDrawData, int drawType, Player drawPlayer, ref Texture2D texture, ref Texture2D glowTexture, ref Vector2 drawPosition, ref Rectangle frame, ref Color drawColor, ref Color glowColor, ref float rotation, ref SpriteEffects spriteEffects, ref Vector2 drawOrigin, ref float drawScale, float shadow) {
        ...
        if (Aequus.HQ) {
            ...
            if (lightIntensity < 0.99f) {
                var balloonFlameColor = flameColor with { A = 0 } * Helper.Wave(Main.GlobalTimeWrappedHourly * 2f, 0.75f, 1f);
