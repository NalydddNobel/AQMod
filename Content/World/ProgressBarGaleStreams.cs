...
{
    public class ProgressBarGaleStreams : EventProgressBar
    {
        ...
        public override bool IsActive() => EventProgressBarLoader.ShouldShowGaleStreamsProgressBar && EventGaleStreams.EventActive(Main.LocalPlayer) && Main.hardMode;
