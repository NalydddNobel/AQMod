...
namespace Aequus.Content.Boss.SpaceSquidMiniboss.Projectiles
{
    public class SpaceSquidLaser : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (prim == null)
            {
                prim = new TrailRenderer(Textures.Trail[2].Value, TrailRenderer.DefaultPass, (p) => new Vector2(Projectile.width - p * Projectile.width), (p) => drawColor * (1f - p),
