...
using Aequus.Content.NPCs.Boss.RedSpriteMiniboss.Rewards;
using Aequus.Content.NPCs.Boss.SpaceSquidMiniboss.Rewards;
using Aequus.Content.NPCs.Boss.UltraStariteMiniboss.Rewards;
...
namespace Aequus.Content.NPCs.Boss {
