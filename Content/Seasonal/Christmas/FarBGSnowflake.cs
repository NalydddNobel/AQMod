...
{
    public class FarBGSnowflake : Common.Graphics.Particles.ParticleType
    {
        ...
        public FarBGSnowflake(Vector2 position, Vector2 velocity = default(Vector2), Color color = default(Color), float scale = 1f)
        {
