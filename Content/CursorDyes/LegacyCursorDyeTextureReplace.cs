...
{
    public abstract class LegacyCursorDyeTextureReplace : CursorDye
    {
        public LegacyCursorDyeTextureReplace(Mod mod, string name) : base(mod, name)
        {
            Textures = new CursorTextureArray(Path);
        }

        protected virtual bool HasOutlines => true;
        protected readonly CursorTextureArray Textures;
