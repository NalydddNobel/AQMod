...
namespace Aequus.Content.Town.CarpenterNPC.Quest.Photobook
{
    public class PhotobookUIState : AequusUIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            var book = ModContent.Request<Texture2D>($"{this.NamespacePath()}/Photobook", AssetRequestMode.ImmediateLoad);
            HAlign = 0.5f;
            VAlign = 0.5f;
        ...
        public void SetupButton(UIElement element, bool left)
        {
            ...
            var image = ModContent.Request<Texture2D>($"{this.NamespacePath()}/PhotobookButton{(left ? "Left" : "Right")}", AssetRequestMode.ImmediateLoad);
