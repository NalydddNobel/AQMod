...
public class GhostRenderer : ModSystem {
    ...
    public static void DrawOntoScreen(SpriteBatch spriteBatch) {
        foreach (var render in Colors) {
            try {
                ...
                var drawData = new DrawData(render.renderTargetCache, Main.screenLastPosition - Main.screenPosition, null, Color.White * Helper.Wave(Main.GlobalTimeWrappedHourly * 5f, 0.6f, 1f), 0f, Vector2.Zero, 2f, SpriteEffects.None, 0f);
    ...
    public override void Load() {
        if (Main.netMode != NetmodeID.Server) {
            ...
            OutlineShader = ModContent.Request<Effect>("Aequus/Assets/Effects/NecromancyOutline");
        }
    }
