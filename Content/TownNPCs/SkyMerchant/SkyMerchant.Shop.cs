...
public partial class SkyMerchant {
    public override void AddShops() {
        ...
        new NPCShop(Type, "Shop")
            .AddCustomValue<SkyHunterCrossbow>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice * 1.5)
            .AddCustomValue<Bellows>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice)
            .AddCustomValue<BalloonKit>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice * 7)
            .Add<NameTag>()
            .Add<Calendar>()
            .AddCustomValue<SlimyBlueBalloon>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.BetweenDays(DayOfWeek.Sunday, DayOfWeek.Monday))
            .AddCustomValue<GoldenFeather>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.BetweenDays(DayOfWeek.Monday, DayOfWeek.Tuesday))
            .AddCustomValue(celestialMagnetAltId, ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.BetweenDays(DayOfWeek.Tuesday, DayOfWeek.Wednesday))
            .AddCustomValue<StunGun>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.BetweenDays(DayOfWeek.Wednesday, DayOfWeek.Thursday))
            .AddCustomValue<WeightedHorseshoe>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.BetweenDays(DayOfWeek.Thursday, DayOfWeek.Friday))
            .AddCustomValue<Furystar>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.BetweenDays(DayOfWeek.Friday, DayOfWeek.Saturday))
            .AddCustomValue<FlashwayShield>(ItemDefaults.Price.SkyMerchantCustomPurchasePrice, AequusConditions.DayOfTheWeek(DayOfWeek.Saturday))
            .Register();
    }
