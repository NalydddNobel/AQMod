...
public class SlimyBlueBalloon : ModItem {
    public static System.Single MaxFallSpeedMultiplier { get; set; } = 0.5f;
    public static System.Single FallGravityMultiplier { get; set; } = 0.5f;
    ...
    public override void UpdateAccessory(Player player, System.Boolean hideVisual) {
        ...
        if (player.velocity.Y > 0f) {
            ...
            player.fallStart = (System.Int32)(player.position.Y / 16f);
        }
    }
}