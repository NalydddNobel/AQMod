...
internal class InstancedBossBag : InstancedModItem {
    ...
    public InstancedBossBag(AequusBoss boss) : base($"{boss.Name}Bag", boss.ItemPath("Bag")) {
        BossName = boss.Name;
        InternalRarity = boss.ItemRarity;
        PreHardmode = boss.PreHardmode;
    }
    ...
    public override LocalizedText DisplayName => Language.GetText("Mods.Aequus.Items.TreasureBag.DisplayName").WithFormatArgs(Language.GetOrRegister($"Mods.Aequus.NPCs.{BossName}.DisplayName"));
    ...
    public override void PostUpdate() {
        ...
        if (Item.timeSinceItemSpawned % 12 == 0) {
            ...
            Dust d = Dust.NewDustPerfect(center + direction * distance, DustID.SilverFlame, velocity);
            d.scale = 0.5f;
            d.fadeIn = 1.1f;
            d.noGravity = true;
            d.noLight = true;
    ...
    public override void ModifyResearchSorting(ref ContentSamples.CreativeHelper.ItemGroup itemGroup) => itemGroup = ContentSamples.CreativeHelper.ItemGroup.BossBags;
