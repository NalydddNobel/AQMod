...
public class FurystarProj : HeldProjBase {
    ...
    public override void AI() {
        ...
        if (!player.CCed) {
            ...
            if (Main.myPlayer == Projectile.owner && heldItem.shoot == Type) {
                ...
                if (Projectile.localAI[0] <= 1f) {
                    ...
                    for (int i = 0; i < Furystar.MaxExtraStars; i++) {
                        ...
                        var source = player.GetSource_ItemUse_WithPotentialAmmo(heldItem, 0, "AequusRemake: Furystar");
            ...
            float wantedRotation = Helper.Wave(Projectile.localAI[1], rotationBase - 0.3f, rotationBase + 0.3f);
