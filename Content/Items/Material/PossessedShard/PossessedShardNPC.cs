...
public class PossessedShardNPC : ModNPC {
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
        ...
        UVVertexStrip.Instance.PrepareUV(add: Main.GlobalTimeWrappedHourly * -1.5f);
        UVVertexStrip.Instance.PrepareStripWithProceduralPadding(NPC.oldPos, NPC.oldRot, (p) => Color.BlueViolet with { A = 0 } * MathF.Pow(1f - p, 4f) * NPC.localAI[1] * 1.2f, (p) => 14f + 20f * MathF.Pow(p, 2f), NPC.Size / 2f - screenPos);
