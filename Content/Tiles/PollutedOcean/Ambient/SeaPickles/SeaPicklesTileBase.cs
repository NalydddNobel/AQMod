...
internal abstract class SeaPicklesTileBase : RubblemakerTile {
    ...
    protected SeaPicklesTileBase(string name, bool natural) : base(name, natural) {
    }
    ...
    public override bool PreDraw(int i, int j, SpriteBatch spriteBatch) {
        ...
        var drawCoordinates = new Vector2(i * 16f, j * 16f + 2f) - Main.screenPosition + Helper.TileDrawOffset;
