...
public class SwagEyePet : ModPet {
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            Main.EntitySpriteDraw(texture, icicleDrawCoords - Main.screenPosition, frame, DrawHelper.GetLightColor(icicleDrawCoords), rotation - MathHelper.PiOver2, new Vector2(frame.Width / 2f, frame.Height - 6), Projectile.scale, SpriteEffects.None, 0);
        }
