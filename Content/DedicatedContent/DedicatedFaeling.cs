...
public class DedicatedFaeling : ModNPC {
    ...
    public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
        ...
        float hue = Main.rgbToHsl(dedicatedItem.FaelingColor).X;
        ...
        for (int num5 = num12; num5 >= num13; num5 -= num14) {
            ...
            float num7 = 1f - num6;
            Vector2 spinningpoint = new Vector2((float)Math.Sin((double)(NPC.whoAmI / 17f) + Main.timeForVisualEffects / (double)num2 + (double)(num6 * 2f * ((float)Math.PI * 2f))) * num16, 0f - num15) * num7;
            Vector2 val = vector2;
            double radians = num4;
