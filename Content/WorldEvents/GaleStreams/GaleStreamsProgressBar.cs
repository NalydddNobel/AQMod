...
namespace AQMod.Content.WorldEvents.GaleStreams
{
    ...
    {
        public override Texture2D IconTexture => ModContent.GetTexture("AQMod/Assets/EventIcons/GaleStreams");
        ...
        public override bool IsActive() => !EventProgressBarLoader.PlayerSafe_GaleStreams && GaleStreams.EventActive(Main.LocalPlayer);
