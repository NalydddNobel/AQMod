...
namespace AQMod.Content.WorldEvents.DemonSiege
{
    public class DemonSiege
    {
        ...
        internal static void Setup()
        {
            ...
            AddDemonSeigeEnemy(DemonSiegeEnemy.FromT<TrapImp>(UpgradeProgression.PreHardmode, DemonSiegeEnemy.SPAWNTIME_PRE_HARDMODE_REGULAR, 32));
            AddDemonSeigeEnemy(DemonSiegeEnemy.FromT<Magmalbubble>(UpgradeProgression.PreHardmode, DemonSiegeEnemy.SPAWNTIME_PRE_HARDMODE_REGULAR, 32));
        }
        ...
        private static void SpawnEnemies(Player player)
        {
            ...
            if (spawnEnemyX != -1 && spawnEnemyY != -1)
            {
                ...
                {
                    DrawUtils.WorldEffects.Add(new DemonSiegeSpawnEffect(spawnEnemyX * 16 + 8, spawnEnemyY * 16 + 16, spawnEnemy));
                }
                spawnEnemyTimer--;
