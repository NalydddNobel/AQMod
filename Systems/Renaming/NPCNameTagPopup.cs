...
public class NPCNameTagPopup : NewUILayer {
    ...
    public NPCNameTagPopup() : base("Name Tag Popup", AequusUI.InterfaceLayers.EntityHealthBars_16, InterfaceScaleType.Game, InsertOffset: -1) { }
}
