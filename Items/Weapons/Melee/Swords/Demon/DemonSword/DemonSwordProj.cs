...
public class DemonSwordProj : HeldSlashingSwordProjectile {
    public override string Texture => AequusTextures.DemonSword.FullPath;
    ...
    public override void AI() {
        ...
        if (!playedSound && AnimProgress > 0.2f) {
            playedSound = true;
            SoundEngine.PlaySound(AequusSounds.SwordSwipe.Value with { Pitch = -0.7f, PitchVariance = 0.1f, }, Projectile.Center);
        }
