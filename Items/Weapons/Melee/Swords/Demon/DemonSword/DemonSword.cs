...
#if DEBUG
        Content.Events.DemonSiege.DemonSiegeSystem.RegisterSacrifice(new(ModContent.ItemType<HellsBoon.HellsBoon>(), Type, Content.Events.DemonSiege.EventTier.Hardmode) { DisableDecraft = true, });
        Content.Events.DemonSiege.DemonSiegeSystem.RegisterSacrifice(new(ModContent.ItemType<Cauterizer.Cauterizer>(), Type, Content.Events.DemonSiege.EventTier.Hardmode) { DisableDecraft = true, });
#endif
    }
