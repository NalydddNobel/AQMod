...
namespace Aequus.Items.Weapons.Magic.StudiesOfTheInkblot;
public class StudiesOfTheInkblot : ModItem {
    public override void Load() {
        DedicationRegistry.Register(this, new DefaultDedication("starlight.mp4", new Color(110, 110, 128, 255)));
    }
