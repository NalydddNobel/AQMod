...
namespace Aequus.Items.Weapons.Magic.Demon.BombarderRod {
    [AutoloadGlowMask]
    [LegacyName("BallisticScreecher")]
    public class BombarderRod : ModItem {
        public override void SetStaticDefaults() {
            Item.staff[Item.type] = true;
            DemonSiegeSystem.RegisterSacrifice(new SacrificeData(ItemID.CrimsonRod, Type, EventTier.PreHardmode));
        }
