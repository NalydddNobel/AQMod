...
namespace AQMod.Items.Weapons.Summon
{
    public class MonoxiderStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
                AQMod.ItemOverlays.Register(new LegacyGlowmask(GlowID.MonoxiderStaff), item.type);
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<MonoxiderMinion>();
    ...
    public class MonoxiderBuff : ModBuff
    {
        ...
        {
            var aQPlayer = player.GetModPlayer<AQPlayer>();
            if (player.ownedProjectileCounts[ModContent.ProjectileType<MonoxiderMinion>()] > 0)
            {
