...
namespace AQMod.Items.Weapons.Summon
{
    public class StariteStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
                AQMod.ItemOverlays.Register(new LegacyGlowmask(GlowID.StariteStaff), item.type);
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<StariteMinionLeader>();
            item.buffType = ModContent.BuffType<StariteMinionBuff>();
            item.autoReuse = true;
            item.shootSpeed = 8f;
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            int stariteChild = Projectile.NewProjectile(position + new Vector2(30f, 10f), new Vector2(speedX, speedY), ModContent.ProjectileType<StariteMinion>(), damage, knockBack, player.whoAmI, stariteParent + 1);
            Main.projectile[stariteChild].minionSlots = 0;
            stariteChild = Projectile.NewProjectile(position + new Vector2(-30f, 10f), new Vector2(speedX, speedY), ModContent.ProjectileType<StariteMinion>(), damage, knockBack, player.whoAmI, stariteParent + 1);
            Main.projectile[stariteChild].minionSlots = 0;
            return false;
        }
    }
    ...
    public class StariteMinionBuff : ModBuff
    {
        public override void SetDefaults()
        {
        ...
        {
            var aQPlayer = player.GetModPlayer<AQPlayer>();
            if (player.ownedProjectileCounts[ModContent.ProjectileType<StariteMinionLeader>()] > 0)
            {
