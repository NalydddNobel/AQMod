...
namespace AQMod.Items.Weapons.Summon
{
    public class CrimsonHandStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<CrimsonHandMinion>();
            item.buffType = ModContent.BuffType<CrimsonHandBuff>();
            item.autoReuse = true;
        }
    ...
    public class CrimsonHandMinion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
    ...
    public class CrimsonHandBuff : ModBuff
    {
        public override void SetDefaults()
        {
        ...
        {
            var aQPlayer = player.GetModPlayer<AQPlayer>();
            if (player.ownedProjectileCounts[ModContent.ProjectileType<CrimsonHandMinion>()] > 0)
            {
