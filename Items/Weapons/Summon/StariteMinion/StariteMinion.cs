...
namespace Aequus.Items.Weapons.Summon.StariteMinion {
    public class StariteMinion : ModProjectile {
        ...
        private void DrawTrail() {
            var trailStartColor = Main.tenthAnniversaryWorld ? Color.LightPink with { A = 0 } : Color.LightCyan with { A = 0 };
            var trailEndColor = Main.tenthAnniversaryWorld ? Color.Pink with { A = 0 } : Color.Blue with { A = 0 };

            AequusDrawing.ApplyBasicEffect(AequusTextures.Trail4);
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Main.EntitySpriteDraw(texture, Projectile.position + offset - Main.screenPosition, null, new Color(255, 255, 255, 0) * Helper.Wave(Main.GlobalTimeWrappedHourly * 6f, 0f, 0.5f), rotation, origin, Projectile.scale, SpriteEffects.None, 0);
            return false;
        }
    }
}