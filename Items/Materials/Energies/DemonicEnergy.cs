...
namespace AQMod.Items.Materials.Energies
{
    public class DemonicEnergy : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
                AQMod.ItemOverlays.Register(new EnergyOverlayData(outline, spotlight, new Vector2(2f, 0f)), item.type);
        }
        ...
        public override void Update(ref float gravity, ref float maxFallSpeed)
        {
            ...
            color.A = 0;
            AQItem.energy_DoUpdate(item, color, new Vector3(0.8f, 0.6f, 0.3f));
        }
    }
}
