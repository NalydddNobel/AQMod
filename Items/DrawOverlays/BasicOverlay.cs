...
{
    public class BasicOverlay : IOverlayDrawWorld, IOverlayDrawInventory, IOverlayDrawPlayerUse
    {
        ...
        internal BasicOverlay(string path, int shader = 0, bool drawInventory = false)
        {
            Path = path;
        ...
        internal BasicOverlay(string path, Color color, int shader = 0, bool drawInventory = false)
        {
            Path = path;
            GetDrawColor = () => color;
            DrawInventory = drawInventory;
        ...
        internal BasicOverlay(string path, Func<Color> color, int shader = 0, bool drawInventory = false)
        {
            Path = path;
            GetDrawColor = color;
            DrawInventory = drawInventory;
