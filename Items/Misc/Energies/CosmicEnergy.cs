...
namespace AQMod.Items.Misc.Energies
{
    public class CosmicEnergy : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                ItemOverlayLoader.Register(new EnergyOverlay(GlowID.CosmicEnergy, outline, spotlight), item.type);
            }
        }
        ...
        private static Color outline(float colorOffset) => new Color(80, (int)(40 + colorOffset), (int)(255 - colorOffset / 2), 180);
        private static Color spotlight(float colorOffset) => new Color(60, (int)(50 - colorOffset), (int)(175 + colorOffset), 255);
