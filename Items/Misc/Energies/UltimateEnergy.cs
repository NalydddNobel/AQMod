...
namespace AQMod.Items.Misc.Energies
{
    public class UltimateEnergy : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                ItemOverlayLoader.Register(new UltimateEnergyOverlay(GlowID.UltimateEnergy, GlowID.UltimateEnergy2, outline, spotlight), item.type);
            }
        }
        ...
        private static Color outline(float colorOffset) => new Color((int)(255 - colorOffset / 4), (int)(210 + colorOffset / 4), 230, 180);
        private static Color spotlight(float colorOffset) => new Color((int)(200 + colorOffset / 2), (int)(255 - colorOffset / 4), 180, 255);
