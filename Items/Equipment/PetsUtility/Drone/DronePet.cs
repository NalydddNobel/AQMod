...
namespace Aequus.Items.Equipment.PetsUtility.Drone;
public class DronePet : ModProjectile {
    public override string Texture => AequusTextures.NPCs_Town_PhysicistNPC_Shimmer_PhysicistPet.FullPath;
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        Main.EntitySpriteDraw(AequusTextures.NPCs_Town_PhysicistNPC_PhysicistPet_Glow, drawCoordinates, frame, Color.White, Projectile.rotation, origin, Projectile.scale, effects, 0);
        return false;
    }
