...
public class WeightedHorseshoeVisual : ModProjectile {
    ...
    public override void AI() {
        ...
        Projectile.rotation = Utils.AngleTowards(Projectile.rotation, wantedRotation, 0.1f);
    ...
    private Color GetStringColor(Vector2 stringStart, Vector2 stringEnd, Color baseColor) {
        return (Utils.MultiplyRGB(DrawHelper.GetLightColor((stringStart + stringEnd) / 2f), baseColor) * 0.75f) with { A = 255, };
    }
