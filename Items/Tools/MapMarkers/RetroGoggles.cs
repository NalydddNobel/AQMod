...
{
    public class RetroGoggles : MapMarkerItem
    {
        ...
        {
            player.AddBuff(ModContent.BuffType<RetroMarkerBuff>(), 20);
        }
    ...
    public class RetroMarkerBuff : ModBuff
    {
        public override void SetDefaults()
        {
        ...
        {
            player.GetModPlayer<AQPlayer>().retroMap = true;
        }
    }
}