...
public class LesserRestorationPotion : ModItem, ItemHooks.IApplyPotionDelay {
    public override string Texture => Aequus.ItemTexture(ItemID.LesserRestorationPotion);
    ...
    public override void AddRecipes() {
        CreateRecipe(3)
            ...
            .TryRegisterBefore(ItemID.RestorationPotion)
            .DisableDecraft();
    }
}