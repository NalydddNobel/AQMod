...
using Aequus.NPCs.BossMonsters.DustDevil.Rewards;
using Aequus.NPCs.BossMonsters.OmegaStarite.Rewards;
using Aequus.NPCs.BossMonsters.UltraStarite.Rewards;
using Aequus.NPCs.RedSprite.Rewards;
...
namespace Aequus.NPCs.BossMonsters {
