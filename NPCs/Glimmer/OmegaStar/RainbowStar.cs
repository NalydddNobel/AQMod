...
namespace AQMod.NPCs.Glimmer.OmegaStar
{
    public class RainbowStar : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int d = Dust.NewDust(projectile.Center + new Vector2(5f, 0f).RotatedBy(Main.rand.NextFloat(-MathHelper.PiOver4, MathHelper.PiOver4) + projectile.velocity.ToRotation()), 4, 4, ModContent.DustType<Dusts.MonoDust>(), 0f, 0f, 0, getColor(Main.GlobalTime), 0.75f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 25; i++)
            {
                int d = Dust.NewDust(projectile.Center + new Vector2(5f, 0f).RotatedBy(Main.rand.NextFloat(-MathHelper.PiOver4, MathHelper.PiOver4) + veloRot), 4, 4, ModContent.DustType<Dusts.MonoDust>(), 0f, 0f, 0, getColor(Main.GlobalTime), 0.75f);
