...
namespace AQMod.NPCs.Glimmer.OmegaStar
{
    public class OmegaRay : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Rectangle frame = new Rectangle(0, 0, texture.Width, texture.Height / Main.projFrames[projectile.type]);
            ...
            Color beamColor = AQNPC.StariteProjectileColor * 0.065f;
            ...
            Vector2 origin2 = new Vector2(texture.Width / 2f, 0f);
            Rectangle frame2 = new Rectangle(frame.X, frame.Y + frame.Height, frame.Width, frame.Height);
            ...
            for (int i = 0; i < repetitions; i++)
            {
                ...
                Color drawColor = Color.Lerp(beamColor, goToColor, lerpValue);
