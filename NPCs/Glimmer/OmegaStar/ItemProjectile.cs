...
namespace AQMod.NPCs.Glimmer.OmegaStar
{
    public class ItemProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            spriteBatch.Draw(SpriteUtils.Textures.Glows[GlowID.UltimateSword], projectile.Center - Main.screenPosition, frame, new Color(250, 250, 250, 0), projectile.rotation, frame.Size() / 2f, projectile.scale, SpriteEffects.None, 0f);
            return false;
        }
        ...
        public override bool TileCollideStyle(ref int width, ref int height, ref bool fallThrough)
        {
            ...
            if (plr.Center.Y < projectile.Center.Y)
                fallThrough = true;
            return true;
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            var dust = ModContent.DustType<Dusts.UltimaDust>();
            for (int i = 0; i < 50; i++)
            {
