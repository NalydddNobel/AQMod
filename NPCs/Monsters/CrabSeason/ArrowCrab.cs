...
namespace AQMod.NPCs.Monsters.CrabSeason
{
    public class ArrowCrab : ModNPC
    {
        ...
        {
            if (Content.World.Events.CrabSeason.Active && Collision.WetCollision(new Vector2(spawnInfo.spawnTileX * 16f - 16f, spawnInfo.spawnTileY * 16f - 16f), 48, 48) && spawnInfo.spawnTileY < Main.worldSurface && SpawnCondition.OceanMonster.Active)
