...
public class Meteor : ModNPC {
    ...
    public override void ModifyNPCLoot(NPCLoot npcLoot) {
        this.CreateLoot(npcLoot)
            ...
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Copper), ItemID.CopperOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Tin), ItemID.TinOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Iron), ItemID.IronOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Lead), ItemID.LeadOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Silver), ItemID.SilverOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Tungsten), ItemID.TungstenOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Gold), ItemID.GoldOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new BlockExistsInWorldCondition(TileID.Platinum), ItemID.PlatinumOre, 2, minimumDropped: 1, maximumDropped: 3))
            .Add(ItemDropRule.ByCondition(new ConditionDownedEvilBoss(), ItemID.Meteorite, minimumDropped: 3, maximumDropped: 12));
    }
