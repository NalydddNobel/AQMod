    ...
    public class CrabsonPearl : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                {
                    projectile.velocity.Y = 8f; // terminal velocity
                }
            }
        ...
        public override bool TileCollideStyle(ref int width, ref int height, ref bool fallThrough)
        {
            fallThrough = Main.player[Player.FindClosest(projectile.position, projectile.width, projectile.height)].position.Y
                > projectile.position.Y + projectile.height; // if the player is below the pearl, fall through platforms
            return true;
        }
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            return false; // keeps the projectile alive
        }
