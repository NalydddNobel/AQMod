...
namespace AQMod.NPCs.Ocean.CrabSeasonEvent
{
    public class SoliderCrabs : ModNPC
    {
        ...
        private class SoliderCrabVisual
        {
            ...
            public void Draw()
            {
                ...
                var texture = AQTextureAssets.GetNPC(ModContent.NPCType<SoliderCrabs>());
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            Main.spriteBatch.Draw(AQTextureAssets.GetNPC(npc.type), center + new Vector2(0f, 2f) - Main.screenPosition, frame, drawColor, npc.rotation, frame.Size() / 2f, npc.scale, SpriteEffects.None, 0f);
            foreach (var vc in _visualCrabs)
            {
                vc.Draw();
            }
