...
using Aequus.NPCs.Boss.Crabson.Rewards;
using Aequus.NPCs.Boss.OmegaStarite.Rewards;
using Aequus.NPCs.Boss.RedSpriteMiniboss.Rewards;
using Aequus.NPCs.Boss.SpaceSquidMiniboss.Rewards;
using Aequus.NPCs.Boss.UltraStariteMiniboss.Rewards;
