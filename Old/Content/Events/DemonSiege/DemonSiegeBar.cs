...
public class DemonSiegeBar : EventBar {
    ...
    public override System.Single GetEventProgress() {
        ...
        return 1f - info.TimeLeft / (System.Single)info.TimeLeftMax;
    }

    public override System.String GetProgressText(System.Single progress) {
        Point p = Main.LocalPlayer.GetModPlayer<DemonSiegePlayer>().GoreNest;
        ...
        System.Int32 seconds = info.TimeLeft / 60;
        System.Int32 minutes = seconds / 60;
