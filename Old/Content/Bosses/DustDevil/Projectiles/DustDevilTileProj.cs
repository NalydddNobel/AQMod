...
public class DustDevilTileProj : ModProjectile {
    ...
    public override void AI() {
        ...
        switch (State) {
            ...
            case STATE_BEINGPULLED: {
                    ...
                    if (npc.ai[0] != DustDevil.SUCTIONTILES) {
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        Main.spriteBatch.Draw(t, drawCoords - Main.screenPosition, frame, ExtendLight.Get(drawCoords, lightColor) * Projectile.Opacity, Projectile.rotation, origin, drawScale * 1.1f, SpriteEffects.None, 0f);
        return false;
    }
