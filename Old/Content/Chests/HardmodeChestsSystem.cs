...
public class HardmodeChestsSystem : ModSystem {
    ...
    public static readonly Dictionary<int, OreTierData> TileIDToOreTier = new();
    ...
    public override void Load() {
        ...
        TileIDToOreTier.Add(TileID.Cobalt, new OreTierData(TileID.Cobalt, ItemID.CobaltOre, ItemID.CobaltBar));
        TileIDToOreTier.Add(TileID.Mythril, new OreTierData(TileID.Mythril, ItemID.MythrilOre, ItemID.MythrilBar));
        TileIDToOreTier.Add(TileID.Adamantite, new OreTierData(TileID.Adamantite, ItemID.AdamantiteOre, ItemID.AdamantiteBar));
        TileIDToOreTier.Add(TileID.Palladium, new OreTierData(TileID.Palladium, ItemID.PalladiumOre, ItemID.PalladiumBar));
        TileIDToOreTier.Add(TileID.Orichalcum, new OreTierData(TileID.Orichalcum, ItemID.OrichalcumOre, ItemID.OrichalcumBar));
        TileIDToOreTier.Add(TileID.Titanium, new OreTierData(TileID.Titanium, ItemID.TitaniumOre, ItemID.TitaniumBar));
    }

    public override void SetStaticDefaults() {
        ChestLootDatabase.Instance.RegisterIndexed(ChestLoot.HardmodeChestRegular,
        ...
        ChestLootDatabase.Instance.RegisterIndexed(ChestLoot.HardmodeChestSnow,
    ...
    private static OreTierData GetOreDataFromTileOrDefault(int tileID, int defaultTileID) {
        return TileIDToOreTier.TryGetValue(tileID, out var val) ? val : TileIDToOreTier[defaultTileID];
    }
