...
public class TriacanthornProj : ModProjectile {
    ...
    public override Color? GetAlpha(Color lightColor) {
        return HamaYumiArrow.FireColor * 2f * Projectile.Opacity;
    }
    ...
    public override void AI() {
        ...
        if (Projectile.timeLeft < 20) {
            ...
            if (Projectile.alpha > 0) {
                ...
                if (Projectile.alpha <= 0) {
                    for (int i = 0; i < 6; i++) {
                        var d = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.SilverFlame, newColor: HamaYumiArrow.FireColor, Scale: Main.rand.NextFloat(0.3f, 1f));
                        d.color *= d.scale * 2f;
                        d.velocity *= d.scale;
                        d.noGravity = true;
                    }
                    for (int i = 0; i < 2; i++) {
                        var d = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.SilverFlame, newColor: HamaYumiArrow.FireColor, Scale: Main.rand.NextFloat(0.4f, 1f));
                        d.color *= d.scale * 2f;
                        d.velocity *= d.scale;
        ...
        Lighting.AddLight(Projectile.Center, HamaYumiArrow.BloomColor.ToVector3() * Projectile.scale);
    }
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        Main.spriteBatch.Draw(texture, Projectile.position + offset + glowOffset - Main.screenPosition, frame, HamaYumiArrow.BloomColor * opacity * 4f, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
        Main.spriteBatch.Draw(texture, Projectile.position + offset - glowOffset - Main.screenPosition, frame, HamaYumiArrow.BloomColor * opacity * 4f, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
        Main.spriteBatch.Draw(texture, Projectile.position + offset - Main.screenPosition, frame, HamaYumiArrow.FireColor * 2f * opacity, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
        if (_glowy > 0f) {
            Main.spriteBatch.Draw(texture, Projectile.position + offset + glowOffset * _glowy * 4f - Main.screenPosition, frame, HamaYumiArrow.BloomColor * 2f * _glowy * opacity, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, Projectile.position + offset - glowOffset * _glowy * 4f - Main.screenPosition, frame, HamaYumiArrow.BloomColor * 2f * _glowy * opacity, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, Projectile.position + offset + glowOffset * _glowy * 8f - Main.screenPosition, frame, HamaYumiArrow.BloomColor * _glowy * opacity, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
            Main.spriteBatch.Draw(texture, Projectile.position + offset - glowOffset * _glowy * 8f - Main.screenPosition, frame, HamaYumiArrow.BloomColor * _glowy * opacity, Projectile.rotation, origin, Projectile.scale, SpriteEffects.None, 0f);
        }
        return false;
    }
