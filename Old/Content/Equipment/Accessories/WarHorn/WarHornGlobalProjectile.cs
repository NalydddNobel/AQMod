...
public class WarHornActivatorGlobalProjectile : GlobalProjectile {
    ...
    public override void AI(Projectile projectile) {
        if (_sourceMinion != -1) {
            int proj = ProjectileHelper.FindProjectileIdentity(projectile.owner, _sourceMinion);
    ...
    public void ActivateWarhorn(Projectile projectile) {
        ...
        if (projectile.minion || projectile.sentry) {
            ...
            proj = ProjectileHelper.FindProjectileIdentity(projectile.owner, _sourceMinion);
        }
