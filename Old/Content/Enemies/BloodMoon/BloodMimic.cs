...
public class BloodMimic : LegacyAIMimic {
    ...
    public override void ModifyNPCLoot(NPCLoot npcLoot) {
        // These only drop when you slay the last Blood Mimic in a group.
        ...
        npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SuspiciousLookingSteak>(), chanceDenominator: 5));
        npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<PotionOfResurrection>(), chanceDenominator: 5));
    }
