...
public class SkyDarkness : ModSystem {
    ...
    public override void Load() {
        value = 1f;
        On_Main.SetBackColor += Main_SetBackColor;
    }

    private static void Main_SetBackColor(On_Main.orig_SetBackColor orig, Main.InfoToSetBackColor info, out Color sunColor, out Color moonColor) {
