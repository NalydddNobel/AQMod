...
namespace AQMod.aprilfools
{
    public class PlaceableCrimsonHeart : ModItem
    {
        ...
        public override bool UseItem(Player player)
        {
            if (player.CanReach_IgnoreItemTileBoost() && CommonUtils.Check2x2ThenCut(Player.tileTargetX, Player.tileTargetY))
            {
                ...
                Main.tile[Player.tileTargetX, Player.tileTargetY].frameX = 36;
                Main.tile[Player.tileTargetX, Player.tileTargetY].frameY = 0;
                Main.tile[Player.tileTargetX + 1, Player.tileTargetY].frameX = 54;
                Main.tile[Player.tileTargetX + 1, Player.tileTargetY].frameY = 0;
                Main.tile[Player.tileTargetX, Player.tileTargetY + 1].frameX = 36;
                Main.tile[Player.tileTargetX, Player.tileTargetY + 1].frameY = 18;
                Main.tile[Player.tileTargetX + 1, Player.tileTargetY + 1].frameX = 54;
